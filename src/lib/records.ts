...
export async function getRecord(recordId: string): Promise<{ record: PatientRecord; entries: RecordEntry[]; synced?: RecordSyncInfo }> {
...
export async function getMyRecord(): Promise<{ record: PatientRecord | null; entries: RecordEntry[]; synced?: RecordSyncInfo }> {
